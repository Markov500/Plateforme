...
Table Of Content
======================
A ACTIVER ET DESACTIVER LE POPUP
B PREVISUALISER UN FICHIER
C VERIFIER LE TYPE D'UN FICHIER
01 PRELOADER
...
function  checkType (f)
{
	...
	if (photo.includes(f.type))
		return "photo";
	else if (video.includes(f.type))
		return "video";
	else
		return "invalide";
}
